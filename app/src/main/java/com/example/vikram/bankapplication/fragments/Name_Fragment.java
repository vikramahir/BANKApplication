...
public class Name_Fragment extends Fragment{
    ...
    private EditText etBankName,etBranch;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        etBranch = (EditText) view.findViewById(R.id.etBranch);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(bankName) && !TextUtils.isEmpty(branch)) {
                   new BankData_Name().execute("https://api.techm.co.in/api/getbank/"+bankName+"/"+branch);

                } else {
                    etBankName.setError("Enter IFSC Code ");
    ...
    public class BankData_Name extends AsyncTask<String, List<BankModel>, List<BankModel>> {
        List<BankModel> list;
        @Override
        ...
        protected void onPostExecute(List<BankModel> result) {
            ...
            if(result!=null) {
                ...
                etBankName.setError("invalid BankName ");
            }
        }
    }
